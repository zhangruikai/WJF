...
import com.bwie.weijifentwo.home.fragment.FragmentDefail;
...
public class IndicaterAdapter extends FragmentPagerAdapter {
    ...
    public Fragment getItem(int position) {
        ...
        FragmentDefail fragmentDetail = new FragmentDefail();
        //fragment 之间传递参数
        Bundle bundle = new Bundle();
        bundle.putString(FragmentDefail.FRAGMENT_ID,appMenus.get(position).classifyId);
